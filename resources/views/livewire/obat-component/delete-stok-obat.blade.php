    ...
    <div class="fixed inset-0 z-10 overflow-y-auto">
        ...
        <div x-show="open"
            ...
            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <p class="text-2xl font-bold">Delete Stok obat</p>

                <form class="space-y-4 md:space-y-6" action="/delete-stock/{{$MD->id}}" method="POST">
                    @csrf

                    <p wire:model="currentMedDate">Apakah anda ingin menghapus stok tanggal {{$MD->medicine_expired_date}}?</p> 
