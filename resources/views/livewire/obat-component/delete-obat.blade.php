    ...
    <div class="fixed inset-0 z-10 overflow-y-auto">
        ...
        <div x-show="open"
            ...
            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <p class="text-2xl font-bold">Delete obat</p>

                <form class="space-y-4 md:space-y-6" action="/delete-obat/{{$medicine->id}}" method="POST">
                    @csrf

                    <p wire:model="currentMedicine">Apakah anda ingin menghapus obat {{$medicine->medicine_name}}?</p> 
