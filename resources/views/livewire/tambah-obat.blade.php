            ...
            <div class="max-w-screen-sm w-full mx-auto bg-white p-8 rounded-md shadow-md">
              ...
              <form method="POST" wire:submit.prevent="submit"  enctype="multipart/form-data">
                ...
                <div class="mb-4">
                  ...
                  @error('name') <span class="error">SALAHHH</span> @enderror
                </div>
                <div class="mb-4">
                  ...
                  @error('stock') <span class="error">SALAHH</span> @enderror
                </div>
                <div class="mb-4">
                  ...
                  @error('expired_date') <span class="error">tanggal ngotak</span> @enderror
                    ...
                    <div class="mb-4">
                        ...
                        @error('expired_date') <span class="error">mana deskripsi?</span> @enderror
                    </div>
                ...
                <div class="mb-4">
                  ...
                  @error('price') <span class="error">harganya wtf</span> @enderror
                </div>
