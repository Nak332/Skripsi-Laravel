        ...
        <div x-show="open"
            ...
            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <p class="text-2xl font-bold text-center">Change Password</p>
                    ...
                    <h1 class="text-3xl py-5 font-bold mb-6 text-center"></h1>
                ...
                @endif
                    <div class="mb-6 mx-4">
                        ...
                        @enderror
                        <input
                        class="appearance-none border border-gray-300 rounded w-full py-2 leading-tight focus:outline-none focus:shadow-outline"
