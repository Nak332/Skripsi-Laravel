        ...
        <div class="min-h-screen flex items-center justify-center">
            <div class="max-w-screen-sm w-full mx-auto bg-white p-8 rounded-md shadow-md">
              ...
              <form method="POST" action="tambah-obat/tambah" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                  <label for="medicine_name" class="block text-gray-700 text-sm font-medium mb-2">Nama<span class="text-red-500">*</span></label>
                  ...
                  @error('medicine_name') <span class="text-xs text-red-500">{{$message}}</span> @enderror
                </div>
               
               
                <div class="mb-4">
                    <label for="medicine_description" class="block text-gray-700 text-sm font-medium mb-2">Deskripsi<span class="text-red-500">*</span></label>
                    ...
                    @error('medicine_description') <span class="text-xs text-red-500">{{$message}}</span> @enderror
                  </div>
                <div class="mb-4">
                  <label for="medicine_price" class="block text-gray-700 text-sm font-medium mb-2">Harga<span class="text-red-500">*</span></label>
                  ...
                  @error('medicine_price') <span class="text-xs text-red-500">{{$message}}</span> @enderror
                </div>
                <hr>
                <br>
                ...
                <div class="mb-4">
                  ...
                  @error('medicine_expired_date') <span class="text-xs text-red-500" value="{{ old('medicine_expired_date') }}">{{$message}}</span> @enderror
                </div>
                <div class="mb-4">
                  ...
                  title="Masukkan angka" value="{{ old('medicine_stock') }}">
                  @error('medicine_stock') <span class="text-xs text-red-500">{{$message}}</span> @enderror
                </div>
