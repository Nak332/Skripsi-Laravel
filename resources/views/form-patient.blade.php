            ...
            <div class="max-w-screen-sm w-full mx-auto bg-white p-8 rounded-md shadow-md">
              ...
              <form method="POST" action="/tambah-pasien/tambah" enctype="multipart/form-data">
                @csrf
                    ...
                    <div><span class="text-red-500">*Wajib diisi</span></div><br>
                <div class="mb-4">
                  <label for="patient_name" class="block text-gray-700 text-sm font-medium mb-2">Nama<span class="text-red-500">*</span></label>
                ...
                <div class="mb-4">
                  <label for="patient_gender" class="block text-gray-700 text-sm font-medium mb-2">Jenis Kelamin<span class="text-red-500">*</span></label>
                ...
                <div class="mb-4">
                    <label for="patient_phone" class="block text-gray-700 text-sm font-medium mb-2">No. Telpon<span class="text-red-500">*</span></label>
                ...
                <div class="mb-4">
                    <label for="patient_address" class="block text-gray-700 text-sm font-medium mb-2">Alamat<span class="text-red-500">*</span></label>
                  ...
                  <div class="mb-4">
                    <label for="patient_DOB" class="block text-gray-700 text-sm font-medium mb-2">Tanggal Lahir<span class="text-red-500">*</span></label>
                  ...
                  <div class="mb-4">
                    <label for="patient_POB" class="block text-gray-700 text-sm font-medium mb-2">Tempat Lahir<span class="text-red-500">*</span></label>
                  ...
                  <div class="mb-4">
                    <label for="patient_marital_status" class="block text-gray-700 text-sm font-medium mb-2">Status Perkawinan<span class="text-red-500">*</span></label>
