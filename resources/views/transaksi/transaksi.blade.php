        ...
        <div id="container_invoice" class=" flex justify-center w-full pt-8">
            <div id="card_pasien" class="w-4/5 p-4 bg-white rounded">
                ...
                <div class="w-full p-2 rounded mt-4 items-center">
                    ...
                    <input type="number" name="quantity" id="quantity" value="{{$item->quantity}}"  placeholder="45000" class="w-1/2 px-4 py-2 border border-gray-300 rounded-md  focus:outline-none focus:ring focus:ring-blue-300">
                    <input type="number" name="price" id="price"  placeholder="45000" class="w-1/2 px-4 py-2 border border-gray-300 rounded-md  focus:outline-none focus:ring focus:ring-blue-300">
                    <br>
                    @endif
                    @endforeach
