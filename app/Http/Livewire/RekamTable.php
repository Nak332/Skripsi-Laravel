...
final class RekamTable extends PowerGridComponent
{
    use ActionButton;
    use WithExport;
    ...
    */
     ...
     *
     * @return Builder<\App\Models\RekamMedis>
     */
    ...
    */
    ...
    /**
     * PowerGrid RekamMedis Action Buttons.
     *
    ...
    public function actions(): array
    {
       return [
           Button::make('edit', 'Edit')
               ...
               ->route('rekam-medis.edit', function(\App\Models\RekamMedis $model) {
                    return $model->id;
               }),

           Button::make('destroy', 'Delete')
               ->class('bg-red-500 cursor-pointer text-white px-3 py-2 m-1 rounded text-sm')
               ->route('rekam-medis.destroy', function(\App\Models\RekamMedis $model) {
                    return $model->id;
               })
               ->method('delete')
        ];
    ...
    */
    ...
    /**
     * PowerGrid RekamMedis Action Rules.
     *
    ...
    public function actionRules(): array
    {
       return [
           ...
           //Hide button edit for ID 1
            Rule::button('edit')
                ->when(fn($rekam-medis) => $rekam-medis->id === 1)
                ->hide(),
        ];
    }
    */
